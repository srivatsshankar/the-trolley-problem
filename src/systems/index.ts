...
export { TrackGenerator } from './TrackGenerator';
export { TrolleyController, type TrolleyState } from './TrolleyController';
...
export { SectionTransitionSystem, createSectionTransitionSystem } from './SegmentTransitionSystem';